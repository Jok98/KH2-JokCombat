...
- `KH2JokCombat_Forms.lua` sblocca tutte le Form, massimizza le cinque progressioni normali, garantisce innate e ricompense vanilla e porta Drive a 9/9; Anti resta correttamente senza livelli.
...
- Nel menu verificare tutte le Form, Drive 9/9, livelli 7, innate e ricompense; poi provare ogni trasformazione/rientro.
